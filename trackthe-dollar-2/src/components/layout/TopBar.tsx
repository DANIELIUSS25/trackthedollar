...
export function TopBar({ title, subtitle, children }: TopBarProps) {
  ...
  return (
    <header
      className={cn(
        "sticky top-0 z-30 flex h-topbar items-center justify-between border-b border-border bg-background/80 px-6 backdrop-blur-md transition-all duration-layout",
